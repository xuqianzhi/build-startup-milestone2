...
function DashboardContent(props) {
  ...
  const handleChangeDisplay = (newDisplay) => {
    props.handleChangeDisplay(newDisplay);
  };
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ display: "flex" }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <Divider />
          <List component="nav">
            {mainListItems(handleChangeDisplay, handleUserSignOut)}
            <Divider sx={{ my: 1 }} />
          </List>
        </Drawer>
        <Box
...
export default class DashboardLandlord extends Component {
  constructor(props) {
    super(props);
    this.handleChangeDisplay = this.handleChangeDisplay.bind(this);
    this.handleUserSignOut = props.handleUserSignOut;
    this.state = {
      displayContent: Maintenance,
    };
  }
  ...
  handleChangeDisplay(newDisplay) {
    this.setState({ displayContent: newDisplay });
  }
}
